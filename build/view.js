...
const MarqueeText = ({
  ...
  }), isShow ? (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", {
    className: "name"
  }, tricker?.name) : (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.RichText, {
    className: "name",
    value: tricker?.name,
    onChange: value => {
      setAttributes({
